...
connection_handler = http_proxy_connect(('www.py4inf.com',80),('10.6.69.50',8080), ('mjr2', '14RedsMascarto'),{})
mysock = connection_handler[0]
mysock.sendall("GET http://www.py4inf.com/sqlite/index.htm HTTP/1.0\n\n")
print mysock.recv(4096)